...
kira_image = pygame.image.load('kira.png')
...
# Загрузка звуков
laugh_sounds = [
    pygame.mixer.Sound('laugh.mp3'),
    pygame.mixer.Sound('laugh1.mp3')
]
scream_sound = pygame.mixer.Sound('Scream_loud.mp3')  # Загружаем звук скримера
